            ...
            return (
              ...
              >
                ...
                <div className="pt-3 border-t border-slate-800 space-y-2.5">
                  ...
                  {/* 📊 Compare Price Button on each product card */}
                  <button
                    onClick={() => handleOpenComparison(prod)}
                    className="w-full py-2 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-700 text-slate-300 hover:text-white font-bold text-xs transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                  >
          ...
          {deliveries.map((del) => (
            <div key={del.id} className="p-4 rounded-2xl bg-slate-950 border border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0 flex-wrap">
                ...
                <button
                  onClick={() => onNavigate && onNavigate('/consumer/support')}
                  className="px-2.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-teal-300 border border-slate-800 text-xs font-semibold transition-colors"
                  title="File Dispute or Complaint"
                >
                  Need Help?
                </button>
